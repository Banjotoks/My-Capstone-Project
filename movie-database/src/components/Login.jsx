...
function Login() {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4 sm:p-6 md:p-8'>
      <h1 className='text-4xl sm:text-3xl font-bold text-center mb-8'>Movie Code</h1>
      <h2 className='text-2xl sm:text-2xl font-bold mb-6 text-center'>Login</h2>
      <form onSubmit={handleSubmit} className='max-w-xs sm:max-w-sm md:max-w-md'> 
        ...
        <button type='submit' className= "bg-green-500 hover:bg-sky-700 mb-2 font-bold py-2 px-4 rounded-lg w-full text-center">Login</button>
